...
const ProdcutForm = ({handleCancel}) => {
    const {
        register,
        handleSubmit,
        reset ,
  ...
  return (
    ...
    <button disabled={loading}  className="bg-sky-500 p-2 rounded-md text-lg font-semibold mt-8 cursor-pointer">Add Product</button>
